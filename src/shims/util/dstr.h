...
extern int wstrcmpi(const wchar_t *str1, const wchar_t *str2);
extern int astrcmp_n(const char *str1, const char *str2, size_t n);
extern int wstrcmp_n(const wchar_t *str1, const wchar_t *str2, size_t n);
extern int astrcmpi_n(const char *str1, const char *str2, size_t n);
extern int wstrcmpi_n(const wchar_t *str1, const wchar_t *str2, size_t n);

extern char *astrstri(const char *str, const char *find);
extern wchar_t *wstrstri(const wchar_t *str, const wchar_t *find);

extern char *strdepad(char *str);
extern wchar_t *wcsdepad(wchar_t *str);

extern char **strlist_split(const char *str, char split_ch, bool include_empty);
extern void strlist_free(char **strlist);
...
extern void dstr_init_copy_strref(struct dstr *dst, const struct strref *src);
...
extern void dstr_copy(struct dstr *dst, const char *array);
static inline void dstr_copy_dstr(struct dstr *dst, const struct dstr *src);
extern void dstr_copy_strref(struct dstr *dst, const struct strref *src);

extern void dstr_ncopy(struct dstr *dst, const char *array, const size_t len);
extern void dstr_ncopy_dstr(struct dstr *dst, const struct dstr *src,
			    const size_t len);
...
extern void dstr_cat_dstr(struct dstr *dst, const struct dstr *str);
extern void dstr_cat_strref(struct dstr *dst, const struct strref *str);

static inline void dstr_cat_ch(struct dstr *dst, char ch);

extern void dstr_ncat(struct dstr *dst, const char *array, const size_t len);
extern void dstr_ncat_dstr(struct dstr *dst, const struct dstr *str,
			   const size_t len);

extern void dstr_insert(struct dstr *dst, const size_t idx, const char *array);
extern void dstr_insert_dstr(struct dstr *dst, const size_t idx,
			     const struct dstr *str);
extern void dstr_insert_ch(struct dstr *dst, const size_t idx, const char ch);

extern void dstr_remove(struct dstr *dst, const size_t idx, const size_t count);

PRINTFATTR(2, 3)
extern void dstr_printf(struct dstr *dst, const char *format, ...);
PRINTFATTR(2, 3)
extern void dstr_catf(struct dstr *dst, const char *format, ...);

extern void dstr_vprintf(struct dstr *dst, const char *format, va_list args);
extern void dstr_vcatf(struct dstr *dst, const char *format, va_list args);

extern void dstr_safe_printf(struct dstr *dst, const char *format,
...
extern void dstr_replace(struct dstr *str, const char *find,
			 const char *replace);
...
extern void dstr_depad(struct dstr *dst);

extern void dstr_left(struct dstr *dst, const struct dstr *str,
		      const size_t pos);
extern void dstr_mid(struct dstr *dst, const struct dstr *str,
		     const size_t start, const size_t count);
extern void dstr_right(struct dstr *dst, const struct dstr *str,
		       const size_t pos);

static inline char dstr_end(const struct dstr *str);

extern void dstr_from_mbs(struct dstr *dst, const char *mbstr);
extern char *dstr_to_mbs(const struct dstr *str);
extern void dstr_from_wcs(struct dstr *dst, const wchar_t *wstr);
extern wchar_t *dstr_to_wcs(const struct dstr *str);

extern void dstr_to_upper(struct dstr *str);
extern void dstr_to_lower(struct dstr *str);
